...
ext_ICRA_buff_debuff_zone_status_t ICRA_buff_debuff_zone_status; // 人工智能挑战赛加成\惩罚区分布与潜伏模式状态
...
ext_game_robot_status_t robot_state;                             // 比赛机器人状态
...
ext_map_interactivity_t map_interactivity;
...
void judgement_data_decode(void)
{
    ...
    case POWER_HEAT_DATA_CMD_ID:
    {
        ...
        //Power_control.powerheat_flag = 1;
    }
    break;
    ...
    {
        memcpy(&aerial_robot_energy, judgement_receive.data, sizeof(aerial_robot_energy_t));
    }
    break;
    ...
    {
        memcpy(&ground_robot_position, judgement_receive.data, sizeof(ground_robot_position_t));
    }
    break;
    case RADAR_MARK_DATA_CMD_ID:
    {
        memcpy(&radar_mark_data, judgement_receive.data, sizeof(radar_mark_data_t));
    }
    break;
    ...
    break;
        ...
        // {
        //     memcpy(&custom_client_data, judgement_receive.data, sizeof(custom_client_data_t));
        // }
        // break;
        // case MAP_SENTRY_CMD_ID:
        // {
        //     memcpy(&map_sentry_data, judgement_receive.data, sizeof(map_sentry_data_t));
        // }
        break;
    default:
    {
